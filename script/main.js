...
const messages = [
    "Кез келген жерге бас!",  
    "Эй, сен ❤️",  
    "Мен саған бір нәрсе айтқым келеді...",  
    "Қане, байқап көр",  
    "Тағы да басып көр",  
    "Жарайды, баса бер, берілме!",  
    "Уәде беремін, бұл соңғы рет",  
    "Шынымен",  
    "Бұл",  
    "Соңғы",  
    "Бірақ бұл әзіл ғой, хехе, ха-ха-ха! Тағы бас!",  
    "Білемін, сен қазір ашулана бастадың",  
    "Хмм...",  
    "Жақсы, жарайды",  
    "Бірақ...",  
    "Мен жай ғана айтқым келгені",  
    "Мен сені жақсы көремін ❤️",  
    "Күнім!",  
    "Төмендегі түймені басып көр 💝"
  ];
